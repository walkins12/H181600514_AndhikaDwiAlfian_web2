    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <label class="col-md-4 col-form-label text-md-left">{!! $kategoriGaleri->created_at->format('d/m/Y H:i') !!}</label>
                </div>
    
                <div class="form-group row">
                <label class="col-md-4 col-form-label text-md-right">Update</label>
                <label class="col-md-4 col-form-label text-md-left">{!! $kategoriGaleri->updated_at->format('d/m/Y H:i') !!}</label>
                </div>
